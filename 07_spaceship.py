...
class Ship:
    ...
    def shoot(self):
        ...
        a_missile = Sprite(self.pos_missile, self.vel_missile, 0, 0, missile_image, missile_info, missile_sound)
...
def draw(canvas):
    ...
    ### print score
    point = (100 , 60 ) # The point is the lower left-hand corner of the text
    text_size = 25
    color = "White"    
    canvas.draw_text("Score", point, text_size, color)
    point = (120 , 90 ) # The point is the lower left-hand corner of the text
    canvas.draw_text(str(score), point, text_size, color)
    
    ### print lives
    point = (WIDTH - 200 , 60 ) # The point is the lower left-hand corner of the text
    text_size = 25
    color = "White"    
    canvas.draw_text("Lives", point, text_size, color)
    point = (WIDTH - 180 , 90 ) # The point is the lower left-hand corner of the text
...
def rock_spawner():
    ...
    a_rock = Sprite([width, height], [1, 1], 0, 0, asteroid_image, asteroid_info)
